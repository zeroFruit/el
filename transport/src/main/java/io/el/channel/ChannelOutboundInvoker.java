...
public interface ChannelOutboundInvoker {
  ...
  /**
   * Request to bind to the given {@link SocketAddress} and notify the {@link ChannelPromise} once the operation
   ...
   * completes, either because the operation was successful or because of an error.
   *
   * The result of the operation will be contained in {@link ChannelPromise}
   * */
