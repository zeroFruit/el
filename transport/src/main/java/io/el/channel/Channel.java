...
public interface Channel {
   ...
   * type such as {@link java.net.InetSocketAddress} to retrieve the detailed info
   * */
  SocketAddress localAddress();

  /**
   * Returns the remote address where this channel is connected to.
   * The returned {@link SocketAddress} is supposed to be down-cast into more
   * concrete type such as {@link java.net.InetSocketAddress} to retrieve the detailed info
   * */
  ...
  interface Internal {
    ...
    /**
     * Connect the {@link Channel} of the given {@link ChannelPromise} with the given remote {@link SocketAddress}.
     * */
