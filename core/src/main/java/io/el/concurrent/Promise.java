...
public interface Promise<V> extends Future<V>, Runnable {
  ...
  /**
   * Returns {@code true} if and only if this asynchronous task done
   * with success.
   * */
  boolean isSuccess();
   ...
   *
   * If it is already success or failed then throws IllegalStateException
   * */
  Promise<V> setSuccess(V result);

  /**
   * Add the listener to this promise. Listener will get notified if this asynchronous task
   * done with success or failure.
   * */
